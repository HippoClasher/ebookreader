...
const positionEnElements = document.querySelectorAll('.positionEn');
positionEnElements.forEach(element => {
  element.textContent = `Chapter ${chapterNumber}, Page ${pageNumber}`;
});
